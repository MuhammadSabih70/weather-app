var touristDestinations = [
  { name: "select your city",latitude:31.5204 ,longitude:74.3587 },
  { name: "Barishal", latitude: 36.3167, longitude: 74.65 },
  { name: "Skardu", latitude: 35.2971, longitude: 75.6333 },
  { name: "Fairy Meadows", latitude: 35.3873, longitude: 74.5785 },
  { name: "Gilgit", latitude: 36.1396, longitude: 74.1928 },
...
function displayData(info) {
  ...
  wind.textContent =`wind:${parseInt(info.wind.speed*1000/3600)}`
}